...
document.addEventListener('keyup', (e) => {
    ...
    if (gameMode === 'single') {
        ...
        // Обработка для игрока 1 (стрелки)
        if (e.code == "ArrowLeft") {
            slideForPlayer(1, 'left');
        }
        else if (e.code == "ArrowRight") {
            slideForPlayer(1, 'right');
        }
        else if (e.code == "ArrowUp") {
            slideForPlayer(1, 'up');
        }
        else if (e.code == "ArrowDown") {
            slideForPlayer(1, 'down');
        }
        
        // Обработка для игрока 2 (WASD)
        else if (e.code == "KeyA") {
            slideForPlayer(2, 'left');
        }
        else if (e.code == "KeyD") {
            slideForPlayer(2, 'right');
        }
        else if (e.code == "KeyW") {
            slideForPlayer(2, 'up');
        }
        else if (e.code == "KeyS") {
            slideForPlayer(2, 'down');
        }
    }
});
